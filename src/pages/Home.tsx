          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
            ...
            >
              ...
              <p className="text-gray-300 text-lg my-6">
                We are the Aeronautics and Space Technology Club (ASTC) of IIT ISM Dhanbad, 
                dedicated to fostering innovation and exploration in aerospace technologies.
              </p>
            ...
            {[
              {
                ...
                title: "Innovation",
                description: "We push the boundaries of what's possible in aerospace engineering through creative solutions."
              },
              {
                icon: <Calendar size={40} className="text-space-accent" />,
                title: "Events",
                description: "From stargazing nights to rocket workshops, we host events that inspire and educate."
              },
              {
                icon: <Users size={40} className="text-space-accent" />,
                title: "Community",
                description: "Join a diverse group of students passionate about space and aeronautics."
              },
              {
                icon: <Brain size={40} className="text-space-accent" />,
                title: "Research",
                description: "We collaborate on research projects with real-world applications in space technology."
              }
            ].map((item, index) => (
              <motion.div
                key={index}
